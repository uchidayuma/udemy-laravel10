    ...
    <div class="grid grid-cols-2 rounded border border-gray-500 mt-4">
      ...
      @for($i = 0; $i < 3; $i++)
          <div class="ingredient flex">
            ...
            <input type="text" name="ingredients[{{$i}}][name]" placeholder="材料名" class="ingredient-name border border-gray-300 p-2 mb-4 w-full rounded">
            :
            <input type="text" name="ingredients[{{$i}}][quantity]" placeholder="分量" class="ingredient-quantity border border-gray-300 p-2 mb-4 w-full rounded">
